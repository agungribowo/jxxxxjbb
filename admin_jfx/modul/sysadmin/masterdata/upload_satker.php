...
if( empty( $_SESSION['id'] ) ){
 ...
 if($_SESSION['level']=="")
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    switch($aksi){
      case 'baru':
         include '../../aksi/sysadmin/masterdat/import_satker.php';
        break;
      case 'tambah':
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row" >
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="./admin?hlm=anaksatker-realisasi" class="btn btn-danger pull-right">
      ...
      <form method="post" action="" enctype="multipart/form-data">
        <a href="upload/downloadfile/satker_realisasi.xlsx" class="btn btn-default">
      ...
      if(isset($_POST['preview'])){
        ...
        if($ext == "xlsx"){
          ...
          echo "<form method='post' action='./admin.php?hlm=upload-satker&aksi=baru'>";
          ...
          foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
            ...
            $out = $row['E']; // Ambil data telepon
            $blok = $row['F']; // Ambil data telepon

            // Cek jika semua data tidak diisi
            if($nis == "" && $nama == "" && $jenis_kelamin == "" && $telp == ""&& $out == "" && $blok == "")
            ...
            if($numrow > 1){
              ...
              $out_td = ( ! empty($out))? "" : " style='background: #E07171;'"; // Jika Telepon kosong, beri warna merah
              $blok_td = ( ! empty($blok))? "" : " style='background: #E07171;'"; // Jika Telepon kosong, beri warna merah
