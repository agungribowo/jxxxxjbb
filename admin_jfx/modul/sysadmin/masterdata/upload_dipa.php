...
if(isset($_POST['btnCari'])){
  ...
  //skrip untuk menampilkan data dari database
      $sql = mysqli_query($koneksi, "SELECT upload_dipa.* 
        FROM upload_dipa
...
if( empty( $_SESSION['id'] ) ){
 ...
 if($_SESSION['level']=="")
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    switch($aksi){
      case 'baru':
        include '../../aksi/sysadmin/upload/upload_dipa.php';
        break;
      // case 'edit':
      //  include 'transaksi_edit.php';
      //  break;
      case 'delete':
    include '../../aksi/sysadmin/upload/delete_dipa.php';
        break;
      // case 'cetak':
   ...
   //skrip untuk menampilkan data dari database
      ...
      if(mysqli_num_rows($sql) > 0){
        ...
        echo '
                ...
                <tr>
               <td>'.$no.'</td>
                  <td>'.$row['judul_dipa'].'</td>
                       <td>'.$row['ta'].'</td>
                    <td>'.$row['bulan_anggaran'].'</td>
                     <td><a href="../../file/'.$row['dipa'].'">'.$row['dipa'].'</a></td>
                       <td>'.$row['tgl_upload'].'</td>
                         <td>'.$row['revisi'].'</td>
                   <td>

<a href="./admin.php?hlm=Upload-DIPA&aksi=delete&kode_sas='.$row['id_dipa'].'" onclick="return konfirmasi()" type="button" class="btn btn-danger" >Delete</a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body"> 
                <form role="form"  action="./admin.php?hlm=Upload-DIPA&aksi=baru" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">DIPA exe upload</label>
