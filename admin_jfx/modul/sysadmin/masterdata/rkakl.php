...
if( empty( $_SESSION['id'] ) ){
 ...
 if($_SESSION['level']=="")
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    switch($aksi){
      case 'baru':
        include '../../aksi/sysadmin/rkakl/rkakl_baru.php';
        break;
      // case 'edit':
      //  include 'transaksi_edit.php';
      //  break;
      case 'delete':
    include '../../aksi/sysadmin/rkakl/delete_rkakl.php';
        break;
      // case 'cetak':
        ...
        echo '
               ...
               <td>'.$no.'</td>
                  <td>'.$row['judul_data'].'</td>
                   ...
                   <td>
                   <a href="./admin.php?hlm=sas&kode_sas='.$row['id_rkakl'].'" onclick="return konfirmasi()" type="button" class="btn btn-default" >Detail</a>
<a href="./admin.php?hlm=rkakl&aksi=delete&kode_sas='.$row['id_rkakl'].'" onclick="return konfirmasi()" type="button" class="btn btn-danger" >Delete</a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body"> 
                <form role="form"  action="./admin.php?hlm=rkakl&aksi=baru" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">RKAKL</label>
