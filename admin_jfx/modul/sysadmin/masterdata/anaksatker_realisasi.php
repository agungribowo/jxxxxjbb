 ...
 if($_SESSION['level']=="")
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    switch($aksi){
      ...
      break;
      case 'hapus':
        include '../../aksi/sysadmin/masterdat/delete_satker.php';
        break;
      // case 'cetak':
...
echo '
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="./admin?hlm=upload-satker" type="button" class="btn btn-primary" >
               Upload Data
              </a>
            </div>
            <!-- /.box-header -->
  ...
  width="100%">
      ...
      $sql = mysqli_query($koneksi, "SELECT  realisasi_satker.*
        FROM  realisasi_satker
        ");
        ...
        echo '
                ...
                <tr>
                 ...
                 <td>'.$row['kode_kegiatan'].'</td>
                  ...
                  <td> ' . number_format($row['pagu'],2,',','.').' </td>
                  <td> ' . number_format($row['realisasi'],2,',','.').' </td>
                 
                   <td>

                  <a href="?hlm=anaksatker-realisasi&aksi=hapus&submit=yes&id_satker='.$row['id_sat'].'" onclick="return konfirmasi()" type="button" class="btn btn-danger" >Hapus</a></td>
                </tr>';
        }
      } else {
