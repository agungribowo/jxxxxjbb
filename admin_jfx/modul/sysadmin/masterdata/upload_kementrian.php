...
if( empty( $_SESSION['id'] ) ){
 ...
 if($_SESSION['level']=="")
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    switch($aksi){
      case 'baru':
        include '../../aksi/sysadmin/masterdat/import_kementrian.php';
        break;
      case 'tambah':
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row" >
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="./admin?hlm=kementerian-realisasi" class="btn btn-danger pull-right">
      ...
      <form method="post" action="" enctype="multipart/form-data">
        <a href="upload/downloadfile/realisasi_kementrian.xlsx" class="btn btn-default">
    ...
    $(document).ready(function(){
      ...
      if(isset($_POST['preview'])){
        ...
        if($ext == "xlsx"){
          ...
          echo "<form method='post' action='./admin.php?hlm=upload&aksi=baru'>";
