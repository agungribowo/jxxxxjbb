 ...
 if($_SESSION['level']=="")
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    switch($aksi){
      ...
      break;
      case 'hapus':
        include '../../aksi/sysadmin/masterdat/delete_ditjen.php';
        break;
      // case 'cetak':
...
echo '
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="./admin?hlm=upload-ditjen" type="button" class="btn btn-primary" >
               Upload Data
              </a>
            </div>
            <!-- /.box-header -->
  ...
  width="100%">
      ...
      $sql = mysqli_query($koneksi, "SELECT  realisasi_ditjen.*
        FROM  realisasi_ditjen
        ");
        ...
        echo '
                ...
                <tr>
                 ...
                 <td>'.$row['nama_kegiatan'].'</td>
                  ...
                  <a href="?hlm=ditjen-realisasi&aksi=hapus&submit=yes&id_ditjen='.$row['id_ditjen'].'" onclick="return konfirmasi()" type="button" class="btn btn-danger" >Hapus</a></td>
                </tr>';
        }
      } else {
