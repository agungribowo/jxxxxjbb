      ...
      <div class="row" >
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="./admin?hlm=add-teknologi"  type="button" class="btn btn-primary">
               Tambah Data
              </a>
    ...
    width="100%">
      ...
      if(mysqli_num_rows($sqlsy) > 0){
        ...
        echo '
                ...
                <tr>
                 <td>'.$no.'</td>
                      <td>'.$rowsy['deskripsi_icon'].'</td>
                  <td>'.$rowsy['judul'].'</td>

                    <td><textarea readonly>'.$rowsy['deskripsi'].'</textarea></td>
                      <td><textarea readonly>'.$rowsy['isi'].'</textarea></td>

                   <td>


                ';?>
  <a href="?hlm=edit-teknologi&id=<?php echo $rowsy['id'] ?>" onclick="return confirm('ANDA YAKIN AKAN MENGEDIT DATA INI ... ?')" type="button" class="btn btn-warning" >Edit</a>
                  <a href="?hlm=teknologi&aksi=hapus_teknologi&submit=yes&id=<?php echo $rowsy['id'] ?>" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA INI ... ?')" type="button" class="btn btn-danger" >Hapus</a></td>
                </tr><?php
        }
      } else {
