...
if( empty( $_SESSION['id'] ) ){
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    $sql = mysqli_query($koneksi, "SELECT jfx_pelatihan_rutin.*
      FROM jfx_pelatihan_rutin
      ...
      if(mysqli_num_rows($sql) > 0){
        ...
        while($row = mysqli_fetch_array($sql)){
          ...
          <a href="#" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA INI ... ?')" type="button" class="btn btn-danger" >Hapus</a>
        </td>
        </tr><?php
      }
    } else {
