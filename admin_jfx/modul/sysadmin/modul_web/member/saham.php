...
if( empty( $_SESSION['id'] ) ){
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    switch($aksi){
      case 'baru':
      include '../../aksi/sysadmin/jfx_member/saham_aksi.php';
      break;
      ...
      break;
      case 'hapus':
      include '../../aksi/sysadmin/jfx_member/saham_hapus.php';
      break;
    ...
    //skrip untuk menampilkan data dari database
      $tsql = " SELECT pemegang_saham.*
            FROM pemegang_saham ";
            $stmt = sqlsrv_query( $conn, $tsql);
            do {
              while ($rowsy = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
          $no++;
          echo '
          <tr>
          <td>'.$no.'</td>
          <td><img src="../../file_saham/'.$rowsy['logo'].'" style="max-width:100%" alt="image description" ></td>
          ...
          ';?>
          <a href="?hlm=edit-member&id=<?php echo $rowsy['id'] ?>" onclick="return confirm('ANDA YAKIN AKAN MENGEDIT DATA INI ... ?')" type="button" class="btn btn-warning" >Edit</a>
          <a href="?hlm=saham&aksi=hapus&submit=yes&id=<?php echo $rowsy['id'] ?>" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA INI ... ?')" type="button" class="btn btn-danger" >Hapus</a></td>
        </tr><?php
        }
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form role="form"  action="./admin?hlm=saham&aksi=baru" method="post" enctype="multipart/form-data">
            <div class="box-body">
