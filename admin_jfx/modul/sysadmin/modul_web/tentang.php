      ...
      <div class="row" >
        <div class="col-xs-12">
          <div class="box">
            ...
            $tsql = " SELECT tentang_kami.*
            FROM tentang_kami where id =1";
            $stmt = sqlsrv_query( $conn, $tsql);
            do {
              while ($row22 = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                    ...
                    <tbody>';
                        ...
                        if(mysqli_num_rows($sql22) > 0){
                          ...
                          echo '
                                  <tr>
                                   <td>'.$no.'</td>
                                   <td><textarea class="form-control" id="editor5" name="editor4" rows="10" cols="80">'.$row22['isi'].'</textarea>
