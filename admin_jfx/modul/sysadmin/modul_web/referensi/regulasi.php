...
if( empty( $_SESSION['id'] ) ){
  ...
  if( isset( $_REQUEST['aksi'] )){
    ...
    $sql = mysqli_query($koneksi, "SELECT jfx_regulasi.*
      FROM jfx_regulasi WHERE kategori='Regulasi'
      ");
      if(mysqli_num_rows($sql) > 0){
        ...
        while($row = mysqli_fetch_array($sql)){
          ...
          <a href="admin.php?hlm=regulasi_del&submit=yes&id=<?php echo $row['id']; ?>" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA INI ... ?')" type="button" class="btn btn-danger" >Hapus</a></td>
        </tr><?php
      }
    } else {
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form role="form"  action="./admin.php?hlm=regulasi_add" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="form-group">
                <label for="exampleInputPassword1">Nomor Keputusan</label>
                <input type="text" class="form-control" name="nomor_kep">
                <input type="hidden" class="form-control" name="kategori" value="Regulasi">
              </div>
              <div class="form-group">
