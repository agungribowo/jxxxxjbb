        ...
        $no = 0;
         ...
         while($row = mysqli_fetch_array($sql)){
          $no++;
            ...
            ?>
            <div class="item" style="background-image:url(file_web/<?php echo $row['gambar']; ?>)">
              <div class="featured-post">
                <div class="post-content">
                  <a class="post-cat" href="#">NAKER</a>
                  <h2 class="post-title title-extra-large">
                    <a href="#"><?php echo $row['judul']; ?></a>
                  </h2>
                  <span class="post-date"><?php echo $row['tgl_update']; ?></span>
                </div>
      ...
      if(mysqli_num_rows($sql) > 0){
        ...
        ?>
          ...
          <div class="featured-tab color-blue">
            <h3 class="block-title"><span>Jadwal Pelaksanaan BIMTEK</span></h3>
            ...
            <div class="tab-content">
                ...
                <?php
  //skrip untuk menampilkan data dari database
      $sql22 = mysqli_query($koneksi, "SELECT pelaksana_bimtek.*
        FROM pelaksana_bimtek
        ");
              ...
              <div class="">
                ...
                <!--  <form action="#" method="post"> -->
                    <div class="form-group">
                      ...
                      <!-- <a href="register.php" class="btn btn-primary btn-block btn-flat">Daftar Peserta Bimtek</a> -->
