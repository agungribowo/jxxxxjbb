...
// Tentukan folder untuk menyimpan file
 ...
 // Tentukan folder untuk menyimpan file
 $folder_dokumen = "../../file/file_laporan/$nama_file_unik";
...
if($sql == true){
			// header('Location: ./admin.php?hlm=unit');
			 echo "<meta http-equiv='refresh' content='0;  URL=../member/admin?hlm=laporan'>";
			die();
		} else {
			 echo "<meta http-equiv='refresh' content='0;  URL=../member/admin?hlm=error'>";
		}
?>
