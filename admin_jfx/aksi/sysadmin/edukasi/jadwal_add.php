...
$sql = mysqli_query($koneksi, "INSERT INTO jfx_webinar (judul, deskripsi, pemateri, waktu, tanggal, tgl_update, url)
      VALUES('$judul', '$deskripsi', '$pemateri', '$waktu', '$tanggal', now(), '$url')"
    );

if($sql == true){
			// header('Location: ./admin.php?hlm=unit');
			 echo "<meta http-equiv='refresh' content='0;  URL=../sysadmin/admin?hlm=jadwal_webinar'>";
			die();
		} else {
