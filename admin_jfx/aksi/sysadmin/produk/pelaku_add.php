...
$folder = "../../pelaku_pasar/$nama_file_unik";
...
$sql = mysqli_query($koneksi, "INSERT INTO jfx_pelaku_pasar (logo, nama_pt, url, tipe_member,
                                no_spab, alamat, email, telp, fax)
      VALUES('$nama_file_unik', '$nama_pt', '$url', '$tipe_member', '$no_spab', '$alamat', '$email', '$telp', '$fax')");

if($sql == true){
			// header('Location: ./admin.php?hlm=unit');
			 echo "<meta http-equiv='refresh' content='0;  URL=../sysadmin/admin?hlm=pelaku'>";
			die();
		} else {
