...
$alphaNumeric = "ABCDEFGHIJKLMNOPQRSTU123456789";
$angka_acak = substr(str_shuffle($alphaNumeric), 0, 5);
...
function warna_acak($jenis_warna = 0){
	...
	if ($jenis_warna == 0){  //warna background
		...
		return imagecolorallocate($my_image, rand(10, 100), rand(100, 255), rand(10, 100));
...
$x += 12;
$y = rand(0,15);
imagestring($my_image, 9, $x, $y, substr($angka_acak, 4, 1), warna_acak(2));
$x += 12;
$y = rand(0,15);
imagestring($my_image, 9, $x, $y, substr($angka_acak, 5, 1), warna_acak(2));
imagejpeg($my_image);
