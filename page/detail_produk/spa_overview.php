                    ...
                    <div class="tab-pane med-text fade in active show" id="tab_sec1">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-lg-5 col-md-6 offset-lg-1">
                                <h6 class="alt-font font-weight-700 text-extra-dark-gray margin-20px-bottom text-uppercase"><?php echo $id; ?></h6>
  ...
  <table width="100%" border="0" class="display table table-striped table-bordered">
    ...
    <tr>
      ...
      <td><input name="btnTampil" type="submit" value=" Tampilkan " /></td>
                                ...
                                <tbody>
                                  <?php
                                  $tsql = "SELECT  TblMarketPreviousSpa.*, contract.* FROM TblMarketPreviousSpa
  ...
  WHERE  contract.ContractID  = '$id' ";
                                  ...
                                  do {
                                    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                      ...
                                      <td>'.$row['BisnisDate']->format('d-m-Y').'</td>
