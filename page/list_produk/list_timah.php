...
$tsql = " SELECT marketsummary.*, contract.*
  FROM marketsummary
...
?>
        ...
        width="100%">
                        ...
                        <tbody>
                          <?php
                          $tsql = " SELECT DISTINCT TinHistory.product
                            FROM TinHistory";
                          $stmt = sqlsrv_query( $conn, $tsql);
                            do {
                            ...
                            $no++;
                              ...
                              echo'
                          <tr>
                            <td>  <a href="media?hal=overview_timah&produk='.$row['product'].'" style="color:blue;padding:5px">
                            '.$row['product'].'</a></td>
