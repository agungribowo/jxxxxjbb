                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6 breadcrumb alt-font text-small justify-content-center justify-content-md-end sm-margin-10px-top">
                        ...
                        <ul>
                            ...
                            <li class="text-dark-gray">Daftar Pembeli Timah</li>
                        </ul>
                        <!-- end breadcrumb -->
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7 text-center margin-100px-bottom sm-margin-40px-bottom">
                        <div class="position-relative overflow-hidden w-100">
                            <span class="text-small text-outside-line-full alt-font font-weight-600 text-uppercase">Daftar Pembeli Timah</span>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<?php
      ...
      $sqlsy = mysqli_query($koneksi, "SELECT jfx_pelaku_pasar.*
        FROM jfx_pelaku_pasar where tipe_member = 'pembeli timah'
...
?>
                    ...
                    <div class="col-12 col-lg-3 col-md-6 wow fadeInUp">
                        <div class="bg-white clients-list text-center  align-items-center justify-content-center w-100 margin-10px-bottom">

                          <table>
                          <th style=" width:35%; padding:2px; "><figure ><a href="javascript:void(0);"><img src="./admin_jfx/jfx_member/pedagang/<?php echo $rowsy['logo']; ?>" style="max-width:100%" alt="image description" ></a></figure></th>
