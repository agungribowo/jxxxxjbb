                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6 breadcrumb alt-font text-small justify-content-center justify-content-md-end sm-margin-10px-top">
                        ...
                        <ul>
                            ...
                            <li class="text-dark-gray">Pedagang</li>
                        </ul>
                        <!-- end breadcrumb -->
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7 text-center margin-100px-bottom sm-margin-40px-bottom">
                        <div class="position-relative overflow-hidden w-100">
                            <span class="text-small text-outside-line-full alt-font font-weight-600 text-uppercase">Daftar Pedagang</span>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<?php
      ...
      $sqlsy = mysqli_query($koneksi, "SELECT jfx_pelaku_pasar.*
        FROM jfx_pelaku_pasar where tipe_member = 'pedagang'
