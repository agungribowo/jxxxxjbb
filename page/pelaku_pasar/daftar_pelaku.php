  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-8 col-md-6 text-center text-md-left">
        <!-- start page title -->
        <h1 class="alt-font text-white-2 font-weight-600 mb-0 text-uppercase">Pelaku Pasar</h1>
        <!-- end page title -->
      </div>
      <div class="col-lg-4 col-md-6 breadcrumb alt-font text-small justify-content-center justify-content-md-end sm-margin-10px-top">
        ...
        <ul>
          ...
          <li class="text-dark-gray"><?php echo $data;?></li>
        </ul>
        <!-- end breadcrumb -->
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-7 text-center margin-100px-bottom sm-margin-40px-bottom">
        <div class="position-relative overflow-hidden w-100">
          <span class="text-small text-outside-line-full alt-font font-weight-600 text-uppercase">Daftar <?php echo $data;?></span>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      $sqlsy = mysqli_query($koneksi, "SELECT jfx_pelaku_pasar.*
        FROM jfx_pelaku_pasar where tipe_member = '$data' ORDER BY nama_pt ASC
        ");
        if(mysqli_num_rows($sqlsy) > 0){
          ...
          while($rowsy = mysqli_fetch_array($sqlsy)){
            ...
            <div class="col-12 col-lg-3 col-md-6 wow fadeInUp">
              <!-- <button type="button" class="view_data btn btn-primary btn-xs" data-toggle="modal" id="<?php echo $rowsy['id']; ?>" data-target="#myModal">Lihat data</button> -->
              <div class="bg-white clients-list text-center  align-items-center justify-content-center w-100 margin-10px-bottom view_data" data-toggle="modal" id="<?php echo $rowsy['id']; ?>" data-target="#myModal">
                <table>
                  <th style=" width:35%; padding:2px; "><figure ><a href="javascript:void(0);"><img src="./admin_jfx/jfx_member/<?php echo $rowsy['logo']; ?>" style="max-width:100px" alt="image description" ></a></figure></th>
