  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-12 d-flex flex-column text-center justify-content-center page-title-large padding-30px-tb">
        <!-- start sub title -->
        <span class="d-block text-white-2 opacity6 alt-font margin-5px-bottom">Peluncuran Produk</span>
        <!-- end sub title -->
        <!-- start page title -->
          ...
          <div class="row">
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>SE-00004/JFX/01-2021</td>
                  <td>Sekilas Mengenai PBK (Perdagangan Berjangka Komoditi)</td>
                  <td>366</td>
