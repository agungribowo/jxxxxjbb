  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-12 d-flex flex-column text-center justify-content-center page-title-large padding-30px-tb">
        <!-- start sub title -->
        <span class="d-block text-white-2 opacity6 alt-font margin-5px-bottom">Regulasi</span>
        <!-- end sub title -->
        <!-- start page title -->
          ...
          <div class="row">
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                $sql = mysqli_query($koneksi, "SELECT  jfx_regulasi.* FROM jfx_regulasi WHERE kategori='Regulasi' ");
                  $no = 0;
