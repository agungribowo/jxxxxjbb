...
echo '
  ...
  width="100%">
    ...
    width="100%">
      ...
      $sqlsy = mysqli_query($koneksi, "SELECT jfx_slide_yellow.*,  jfx_icon_db.*
        FROM jfx_slide_yellow
        INNER JOIN  jfx_icon_db on jfx_slide_yellow.icon=jfx_icon_db.id_icon
      ...
      if(mysqli_num_rows($sqlsy) > 0){
        ...
        echo '
                ...
                <tr>
                 <td>'.$no.'</td>
                      <td>'.$rowsy['data_icon'].'</td>
                  <td>'.$rowsy['judul'].'</td>

                    <td>'.$rowsy['deskripsi'].'</td>
                ...
                ';?>
                  ...
                  <a href="?hlm=home&aksi=hapus_kuning&submit=yes&id=<?php echo $rowsy['id'] ?>" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA INI ... ?')" type="button" class="btn btn-danger" >Hapus</a></td>
                </tr><?php
        }
      } else {
        ...
        echo '
                <tr>
                 ...
                 <td>'.$row['video_url'].'</td>
                  ...
                  <td> ';?>
                  <a href="?hlm=video_edit&id=<?php echo $row['id'] ?>" onclick="return confirm('ANDA YAKIN AKAN MENGUBAH DATA INI ... ?')" type="button" class="btn btn-warning" >Edit</a>
                </td>
